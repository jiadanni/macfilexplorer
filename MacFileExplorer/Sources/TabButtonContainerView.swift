...
class TabButtonContainerView: NSView {
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        if isSelected {
            ...
            eraseLine.lineTo(NSPoint(x: bounds.maxX, y: bounds.maxY))
